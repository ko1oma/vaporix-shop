...
(function(){
  function loadFixes(){if(document.getElementById('vaporix-runtime-fixes-script'))return;const s=document.createElement('script');s.id='vaporix-runtime-fixes-script';s.src='runtime_fixes.js?v=2026.08.26.19';s.defer=true;(document.head||document.documentElement).appendChild(s)}
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',loadFixes,{once:true});else loadFixes();
})();
(function(){
  function loadCheckoutBackFix(){if(document.getElementById('vaporix-checkout-back-fix-script'))return;const s=document.createElement('script');s.id='vaporix-checkout-back-fix-script';s.src='checkout_back_fix.js?v=2026.08.26.19';s.defer=true;(document.head||document.documentElement).appendChild(s)}
...
(function(){
  function loadCheckoutPositionFix(){if(document.getElementById('vaporix-checkout-position-fix-script'))return;const s=document.createElement('script');s.id='vaporix-checkout-position-fix-script';s.src='checkout_position_fix.js?v=2026.08.26.19';s.defer=true;(document.head||document.documentElement).appendChild(s)}
